...
<Card title="File Structure" icon="folders" href="/overview/file-structure" horizontal>
...
<Card title="Initial Setup" icon="tool" href="/setup/initial-setup" horizontal>
  Complete technical configuration including cron jobs
</Card>

<Card title="Configuration Guide" icon="settings" href="/setup/configuration" horizontal>
