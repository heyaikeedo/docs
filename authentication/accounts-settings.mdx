...
description: Configure user account options and security policies for your Aikeedo platform
---

The Account Settings page allows you to manage crucial aspects of user accounts on your Aikeedo platform. These settings control user registration, sign-in processes, and email verification policies, ensuring a balance between user accessibility and platform security.
