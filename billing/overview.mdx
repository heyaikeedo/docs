...
The model used for title generation is set for the whole installation in **Settings → Features → Utilities**.

### Charge for Prompt Enhancement

Control whether the prompt tools in the Imagine and Video composers incur a cost. This covers both **Enhance** and **Surprise me**.

- **Enabled**: Each enhanced or generated prompt incurs a cost and is charged to the workspace
- **Disabled**: The prompt tools are provided free of charge
...
- [Stripe Integration](/integrations/payment-gateways/stripe) - Configure Stripe payments
- [PayPal Integration](/integrations/payment-gateways/paypal) - Configure PayPal payments
