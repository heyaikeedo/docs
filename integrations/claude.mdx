...
description: 'Integrate Anthropic Claude AI models (Claude Sonnet, Opus, Haiku) into Aikeedo for advanced chat, Canvas documents, and content generation.'
---
...
1. **Chat**: Engage in sophisticated, context-aware conversations, with Canvas documents and clarifying questions.
