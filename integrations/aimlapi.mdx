...
<Warning>
**Integration Status: Removed in v5.0**

This integration existed to power the Composer (music) tool through the Suno API, which was discontinued on November 27, 2024. Composer and this integration were removed in Aikeedo v5.0, and existing compositions are deleted when you update. See the [v5.0 release notes](/versioning/release-notes#composer-removed).

AI/ML API language models can still be added as a custom LLM server. See [OpenAI API Compatibility](/integrations/openai-api-compatibility). The rest of this page applies to v4.x and earlier only.
</Warning>
