...
AI/ML API integration provides access to the following Chirp models:

`chirp-v3-5`, `chirp-v3-0`

These models offer advanced language processing capabilities, allowing you to choose the best fit for your specific use case.
