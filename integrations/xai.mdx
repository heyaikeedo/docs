...
Aikeedo currently supports the following xAI models:
...
1. Contact [Aikeedo support](mailto:support@aikeedo.com)
2. Review xAI's documentation for API-specific issues
3. Check your xAI account status and subscription details

<Note>
  Keep track of xAI's usage policies and pricing to manage costs effectively.
</Note>