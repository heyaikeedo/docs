...
<Card title="Digital Ocean Spaces" icon="digital-ocean" href="/integrations/digital-ocean-spaces">
  S3-compatible storage with simple pricing and easy setup.
</Card>

<Card title="Cloudflare R2" icon="cloudflare" href="/integrations/cloudflare-r2">
  S3-compatible storage with zero egress fees.
</Card>

<Card title="Wasabi" icon="/images/wasabi-icon.svg" href="/integrations/wasabi">
  High-performance cloud storage with S3-compatible API.
</Card>

<Card title="MinIO" icon="/images/minio-icon.svg" href="/integrations/minio">
