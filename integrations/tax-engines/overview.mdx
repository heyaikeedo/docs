...
<CardGroup cols={2}>
<Card title="Manual Tax Engine" icon="adjustments-horizontal" href="/integrations/tax-engines/manual-tax">
  Define flat and percentage tax rates manually by country and subdivision. Full control, no external services required.
</Card>

<Card title="Stripe Tax" icon="brand-stripe" href="/integrations/tax-engines/stripe-tax">
