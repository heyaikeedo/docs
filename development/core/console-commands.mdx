...
Scaffolds a new module in `src/` with the standard layout: entity, value objects, repository, CRUD commands and handlers, and a bootstrapper. Useful for learning the conventions; remember that `src/` is replaced on update.
