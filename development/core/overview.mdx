...
flowchart LR
    ...
    subgraph Handle
        direction TB
        G[Route dispatch] --> H[Middleware pipeline]
        H --> I[Request handler]
        I --> J[Command bus]
    ...
    subgraph Finish
        direction TB
        L[Response emitted] --> M[EntityManager flush]
    end
...
<CardGroup cols={2}>
  <Card title="Directory structure" icon="folders" href="/development/core/directory-structure">
    What lives where in an installation.
  </Card>
  <Card title="Modules and layers" icon="stack-2" href="/development/core/modules-and-layers">
    Domain, application and infrastructure inside a module.
  </Card>
  <Card title="Events" icon="broadcast" href="/development/core/events">
