...
| `LicenseMiddleware` | A valid license, for admin views |
...
- To authenticate someone who isn't an Aikeedo user, such as a widget visitor, issue your own scoped token and verify it in your own middleware. See [Public endpoints and embeds](/development/plugins/public-endpoints-and-embeds).
