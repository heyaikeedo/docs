...
<CardGroup cols={2}>
  ...
  <Card title="Structure" icon="folder-tree" href="/development/themes/structure">
    What every directory and file is for.
  </Card>
  <Card title="Template objects" icon="brackets-curly" href="/development/themes/template-objects">
