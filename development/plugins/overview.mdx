...
<CardGroup cols={2}>
  ...
  <Card title="Lifecycle and hooks" icon="arrows-rotate" href="/development/plugins/lifecycle-and-hooks">
    Install, activate, deactivate, uninstall and update.
  </Card>
  <Card title="Services you can inject" icon="syringe" href="/development/plugins/dependency-injection-and-services">
