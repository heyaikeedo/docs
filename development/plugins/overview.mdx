...
<Note>
This guide reflects the Aikeedo v5.x structure. Since v3.0, plugins and themes are located in `/extra/extensions/` with assets in `/public/e/`.
</Note>
...
Plugins and themes use a standardized directory structure:
