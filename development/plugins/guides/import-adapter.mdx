...
<Check>A small archive imports completely, and conversations appear in the library.</Check>
<Check>A large archive imports across several cron ticks without timing out.</Check>
<Check>Re-importing the same archive skips existing conversations instead of duplicating them.</Check>
<Check>A corrupt archive fails the job with a readable error, rather than looping forever.</Check>
<Check>Temporary files are removed when the job finishes.</Check>
