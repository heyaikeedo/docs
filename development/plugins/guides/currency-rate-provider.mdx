...
<Check>Set a gateway to a currency other than the platform default and confirm the charge is converted.</Check>
<Check>The converted amount is plausible, and rounding lands on whole minor units.</Check>
<Check>Rates are fetched once and reused until they expire.</Check>
<Check>With an invalid API key, checkout still completes in the default currency.</Check>
