...
<Check>Checkout shows your tax lines, and the total includes them.</Check>
<Check>A workspace without an address still reaches checkout.</Check>
<Check>A zero or missing rate produces no tax line at all.</Check>
<Check>A discounted order taxes the amount you intended.</Check>
<Check>With the service unreachable, checkout still completes.</Check>
