...
<Check>Your section appears in the plan editor, both for new and existing plans.</Check>
<Check>Saving a plan persists your values, and reopening shows them.</Check>
<Check>A snapshot of the plan shows your read-only summary.</Check>
<Check>A workspace on a plan with the capability disabled is blocked by your checks.</Check>
<Check>A cap is enforced at the limit, not one over.</Check>
