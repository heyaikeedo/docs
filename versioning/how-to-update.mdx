...
<Warning>
  **Upgrading to v5.0?** The standard update process on this page works, but
  v5.0 removes tools and requires every plugin to be updated. Read the [v5.0
  breaking changes and upgrade steps](/versioning/release-notes#upgrading-to-v5-0)
  before you start.
</Warning>
