...
- [404 or 403 Errors During Installation](#404-or-403-errors)
- [Database Connection Issues](#database-connection)
- [500 Internal Server Error During Installation](#500-internal-server-error)
- [Installation Wizard Not Loading](#installation-wizard-not-loading)

### Configuration Issues
- ["Does Not Allow the Value" Error](#does-not-allow-value)
- [Cannot Select Models or Send Prompts](#cannot-select-models)
- [500 Error on Image Generator or Video Generator](#500-error-generators)

### Database Issues
- [MySQL Server Has Gone Away](#mysql-server-gone-away)

### Feature-Specific Issues
- [Auto-Generated Titles Don't Match Content Language](#title-language-mismatch)
- [Uploaded Files Return 404 Not Found Errors](#files-404-errors)

---

## Installation Issues

<a id="assets-not-loading"></a>
...
<a id="500-internal-server-error"></a>
...
<a id="installation-wizard-not-loading"></a>
...
<a id="title-language-mismatch"></a>
