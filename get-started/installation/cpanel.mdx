...
1. Ensure your server meets our [requirements](/get-started/requirements).
...
In cPanel, this typically means:
  ...
  <Tab title="Main Domain">
    ...
    <Steps>
        ...
        <Step title="Configure the Public Directory">
            ...
            <Warning>
                Important: You'll need to manually repeat this step after each Aikeedo update. For more details on the update process, please refer to our [update guide](/versioning/how-to-update).
            </Warning>
        </Step>
